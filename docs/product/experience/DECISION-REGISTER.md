...
| 2.2 | 2026-08-17 | Experience Architecture Final Integration (E1–E8) canonized. All X-01–X-38 requirements and F-01–F-38 founder decisions expressly preserved as binding; none resolved or superseded by the integration layer. No runtime changes made. |
| 2.3 | 2026-08-17 | Visual / Sonic / Interaction Design Foundation v1.0 canonized as a subordinate layer. A separate [Design Decision Register](../design/DESIGN-DECISION-REGISTER.md) now holds design decisions D-01–D-14; X-01–X-38 and F-01–F-38 remain controlling and unchanged. No runtime changes made. |
