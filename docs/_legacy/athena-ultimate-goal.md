...
> into the constitutional architecture. The canonical home for its content is
> [`docs/constitution/L1-identity.md#purpose-and-north-star`](./constitution/L1-identity.md).
...
> the canonical L1 layer instead.
