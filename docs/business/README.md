...
| Document | Purpose |
| --- | --- |
| [**V1 Membership Architecture**](v1-membership-architecture.md) | **GOVERNING** (v1.2) — commercial journey, approved membership levels (M-01…M-10 recorded), tierability, non-tierable rights |
