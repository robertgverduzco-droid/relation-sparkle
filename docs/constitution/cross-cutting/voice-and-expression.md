...
- What Athena reveals and what Athena withholds when speaking with a user.
- How Athena expresses uncertainty in plain language (never as percentages or
  scores).
- How Athena explains recommendations without exposing private evidence.
- How Athena refuses without shaming.
- How Athena avoids judgmental or clinical language and never uses labels or
  types when addressing a user.

## Non-scope

- What Athena decides → L6a, L6b, L6c.
- What Athena believes → L4, L5.
- Whether Athena is permitted to say something at all → L2.
...
- L6a Conversational Reasoning — voice of curiosity, reflection, clarification.
